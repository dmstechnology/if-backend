...
context.load_cert_chain('/etc/letsencrypt/live/csvapp.cloudschool.tech/fullchain.pem','/etc/letsencrypt/live/csvapp.cloudschool.tech/privkey.pem')
#context.use_certificate_file('/etc/letsencrypt/live/csvapp.cloudschool.tech/fullchain.pem')
